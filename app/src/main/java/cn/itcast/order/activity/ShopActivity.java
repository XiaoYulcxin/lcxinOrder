...
import cn.itcast.order.beans.ShopBean;
...
public class ShopActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        tv_title.setText(R.string.app_nav_name);
        RelativeLayout rl_title_bar = (RelativeLayout) findViewById(R.id.title_bar);
        rl_title_bar.setBackgroundColor(getResources().getColor(android.R.color.white));
        tv_back.setVisibility(View.GONE);
        //列表控件
        ShopListView slv_list = (ShopListView) findViewById(R.id.slv_list);
